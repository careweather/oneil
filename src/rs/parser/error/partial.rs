...
//!
//! ```rust
//! use crate::parser::error::partial::{ErrorsWithPartialResult, CanBeEmpty};
//!
//! // Example: parsing a list that might have some valid elements
//! let result: ErrorsWithPartialResult<Vec<i32>, ParserError> =
//!     ErrorsWithPartialResult::new(
//!         vec![1, 2, 3], // partial result
//!         vec![/* some errors */] // errors encountered
//!     );
//! ```
//!
...
///
/// ```rust
/// use crate::parser::error::partial::ErrorsWithPartialResult;
///
/// // A parser that successfully parsed 3 items but failed on the 4th
/// let result = ErrorsWithPartialResult::new(
///     vec!["item1", "item2", "item3"], // partial result
///     vec![/* error from 4th item */]  // errors
/// );
/// ```
