...
LEGACY_UNITS = {
    ...
    "dec.": ({"s": 1}, 3.1556952e8, {"alt": ("decade", "decades")}), 
    "yr": ({"s": 1}, 3.1556952e7, {"alt": ["year", "yr", "years"]}),
    "mon": ({"s": 1}, 2.629746e6, {"alt": ["month", "months"]}),
    "week": ({"s": 1}, 6.048e5, {"alt": ["weeks", "wk", "wks"]}),
    "day": ({"s": 1}, 8.64e4, {"alt": ["day", "days", "dy", "dys"]}),
    "hr": ({"s": 1}, 3600, {"alt": ["hour", "hrs", "hours"]}),
    "min": ({"s": 1}, 60, {"alt": ["minute", "mins", "minutes"]}),
