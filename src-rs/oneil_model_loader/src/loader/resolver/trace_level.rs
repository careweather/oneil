    ...
    fn test_resolve_none_trace_level() {
        {
            ...
            let expected_module_level = oneil_ir::debug_info::TraceLevel::None;
    ...
    fn test_resolve_trace_trace_level() {
        {
            ...
            let expected_module_level = oneil_ir::debug_info::TraceLevel::Trace;
    ...
    fn test_resolve_debug_trace_level() {
        {
            ...
            let expected_module_level = oneil_ir::debug_info::TraceLevel::Debug;
