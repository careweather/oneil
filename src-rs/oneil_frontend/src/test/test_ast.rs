...
pub fn literal_number_node(number: f64) -> ast::Node<ast::Literal> {
    ...
    ast::Node::new(literal, unimportant_span(), unimportant_span())
}
...
pub fn literal_number_expr_node(number: f64) -> ast::Node<ast::Expr> {
    ...
    ast::Node::new(expr, unimportant_span(), unimportant_span())
}
...
pub fn trace_level_trace_node() -> ast::Node<ast::TraceLevel> {
    let trace_level = ast::TraceLevel::Trace;
    ast::Node::new(trace_level, unimportant_span(), unimportant_span())
}

pub fn trace_level_debug_node() -> ast::Node<ast::TraceLevel> {
    let trace_level = ast::TraceLevel::Debug;
    ast::Node::new(trace_level, unimportant_span(), unimportant_span())
}

pub fn binary_op_node(op: ast::BinaryOp) -> ast::BinaryOpNode {
    ast::Node::new(op, unimportant_span(), unimportant_span())
}
...
pub fn identifier_variable_node(name: &'static str) -> ast::Node<ast::Variable> {
    ...
    let identifier_node = ast::Node::new(identifier, unimportant_span(), unimportant_span());
    let variable = ast::Variable::Identifier(identifier_node);
    ast::Node::new(variable, unimportant_span(), unimportant_span())
}
...
pub fn simple_parameter_value_node(expr: ast::ExprNode) -> ast::Node<ast::ParameterValue> {
    ...
    ast::Node::new(value, unimportant_span(), unimportant_span())
}
...
pub fn continuous_limits_node(min: f64, max: f64) -> ast::Node<ast::Limits> {
    ...
    ast::Node::new(limits, unimportant_span(), unimportant_span())
}
...
pub fn unit_node(identifier: &'static str) -> ast::Node<ast::UnitExpr> {
    ...
    ast::Node::new(unit, unimportant_span(), unimportant_span())
}
...
pub fn unit_binary_op_node(
    ...
    let op_node = ast::Node::new(op, unimportant_span(), unimportant_span());
...
impl ModelBuilder {
    ...
    fn with_model_import(mut self, name: &'static str, model_kind: ast::ModelKind) -> Self {
        ...
        let model_import = ast::SubmodelDecl::new(vec![], model_import_info_node, None, model_kind);
        let model_import_node =
            ast::Node::new(model_import, unimportant_span(), unimportant_span());
        let decl = ast::Decl::submodel(model_import_node);
    ...
    pub fn with_section(mut self, section: &'static str, decls: Vec<ast::DeclNode>) -> Self {
        ...
        let section_header_node =
            ast::Node::new(section_header, unimportant_span(), unimportant_span());
...
impl ImportModelNodeBuilder {
    ...
    pub fn build(self) -> ast::SubmodelDeclNode {
        ...
        let submodel_list = self.submodel_list.map(|submodel_list| {
            ast::Node::new(
                ast::SubmodelList::new(submodel_list),
                unimportant_span(),
                unimportant_span(),
            )
        });

        let submodel = ast::SubmodelDecl::new(self.directory_path, model_info, submodel_list, kind);

        ast::Node::new(submodel, unimportant_span(), unimportant_span())
    }

    pub fn build_as_decl_node(self) -> ast::DeclNode {
        let submodel = self.build();
        let decl = ast::Decl::submodel(submodel);
        ast::Node::new(decl, unimportant_span(), unimportant_span())
    }
}
...
impl ModelInfoNodeBuilder {
    ...
    pub fn build(self) -> ast::ModelInfoNode {
        ...
        ast::Node::new(model_info, unimportant_span(), unimportant_span())
    }
}
...
impl ImportPythonNodeBuilder {
    pub fn build(path: &'static str) -> ast::ImportNode {
        let path = ast::Node::new(path.to_string(), unimportant_span(), unimportant_span());
        let import = ast::Import::new(path);
        ast::Node::new(import, unimportant_span(), unimportant_span())
    }
}
...
impl ParameterNodeBuilder {
    ...
    pub fn with_piecewise_values(
        ...
        let values = values_and_conds
            ...
            .map(|piecewise_part| {
                ast::Node::new(piecewise_part, unimportant_span(), unimportant_span())
            })
            .collect();
    ...
    pub fn with_continuous_limit_vars(
        ...
        let limits_node = ast::Node::new(limits, unimportant_span(), unimportant_span());
    ...
    pub fn build(self) -> ast::ParameterNode {
        ...
        ast::Node::new(parameter, unimportant_span(), unimportant_span())
    }
}
...
impl TestNodeBuilder {
    ...
    pub fn with_debug_trace_level(mut self) -> Self {
        let trace_level = ast::TraceLevel::Debug;
        let trace_level_node = ast::Node::new(trace_level, unimportant_span(), unimportant_span());
    ...
    pub fn build(self) -> ast::TestNode {
        ...
        ast::Node::new(test, unimportant_span(), unimportant_span())
    }
}
